            ...
            <div className='absolute top-1/2 left-1/2 translate-y-[-50%] translate-x-[-50%]'>
                ...
                >
                    <div className='block'>
                        ...
                        <input id="user" type="text" name="username" className="bg-slate-100 my-1 h-3 border border-slate-200 placeholder:text-slate-500 text-sm p-2.5 placeholder:italic" placeholder="Username"/>
                    </div>
                    <div className='block'>
